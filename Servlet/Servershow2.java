...
import java.sql.*;
public class Servershow2 extends HttpServlet
{
	public void doGet(HttpServletRequest request,HttpServletResponse response) throws IOException,ServletException
	{
		...
		try
		{
          ...
          Statement st=con.createStatement();  
			String q="select * from  marks LIMIT 5 OFFSET 5";
			ResultSet re=st.executeQuery(q);
			out.println("<center>");
			out.println("<table cellpadding='12px'>");
			out.println("<tr><th> Roll</th> <th>Name</th> <th>Phy</th> <th>Chem</th> <th>Maths</th> </tr>");
			while(re.next())
			{
				out.println("<tr>");
			...
			out.println("<br>");
			out.println("<br>");
			out.println("<form action='kkk'><center><table> <tr><th><input type='Submit' value='Page 3'></th></tr></table></center></form>");
